package md5557dac8d3704e5bdedc782af5d0ed40c;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Aplicativo_Ble.Droid.bleServerNative+BleAdvertiseCallback, Aplicativo_Ble.Android", bleServerNative_BleAdvertiseCallback.class, __md_methods);
	}
	...
	public bleServerNative_BleAdvertiseCallback ()
	{
		...
		if (getClass () == bleServerNative_BleAdvertiseCallback.class)
			mono.android.TypeManager.Activate ("Aplicativo_Ble.Droid.bleServerNative+BleAdvertiseCallback, Aplicativo_Ble.Android", "", this, new java.lang.Object[] {  });
	}
